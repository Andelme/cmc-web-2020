INSERT INTO DEPARTMENT (department_id, department_name, head_department) VALUES
(1, 'Andelme Headquarters', NULL),
(2, 'Andelme Research', 1),
(3, 'Andelme Mechanics', 1),
(4, 'Отдел кадров', 1),
(5, 'Финансовый отдел', 1),
(6, 'Плановый отдел', 1),
(7, 'Отдел научных исследований', 2),
(8, 'Производственный отдел', 3);

INSERT INTO POSITION_TYPE (postype_id, postype_name, responsibilities, salary) VALUES
(1, 'Начальник отдела кадров', 'Возглавляет работу по набору и распределению работников по рабочим местам, ' ||
...
(2, 'Начальник финансового отдела', 'Организует управление движением финансовых ресурсов предприятия и регулирование финансовых отношений, ' ||
...
(3, 'Бухгалтер', 'Ведёт первичный бухгалтерский учёт, ' ||
                 'производит расчёт, начисление, а также перечисление налогов по отчётным периодам, ' ||
                 'Осуществляет выплаты работникам', 60000),
(4, 'Начальник планового отдела', 'Организует контроль за выполнением подразделениями предприятия плановых заданий, ' ||
                                  ...
                                  'Руководит работниками отдела', 160000),
(5, 'Финансовый аналитик', 'Анализирует деятельность организации, ' ||
...
(6, 'Лаборант', 'Следит за исправным состоянием лабораторного оборудования, осуществляет его наладку, ' ||
...
(7, 'Руководитель исследовательского отдела', 'Разрабатывает проекты перспективных и годовых планов работы подразделения и представляет их руководству, ' ||
                                              ...
                                              'Руководит работниками отдела', 160000),
(8, 'Сотрудник исследовательской лаборатории', 'обосновывает направления новых исследований и разработок и методы их выполнения, ' ||
...
(9, 'Руководитель отдела производства', 'Организует техническую подготовку производства, ' ||
...
(10, 'Инженер-конструктор', 'Разрабатывает эскизные, технические и рабочие проекты особо сложных, сложных и средней сложности изделий, ' ||
...
INSERT INTO WORKER (worker_id, name, birth_date, address, phone_number, hire_date, education_degree) VALUES
(1, 'Афанасьева Екатерина Сергеевна', '1980-03-23', 'Москва, ул.Леваневского, д.77, кв.59', '+7(965)874-04-31', '2005-01-05', 'doctor'),
(2, 'Иванов Алексей Дмитриевич', '1976-01-19', 'Москва, ул.Трехгорный Вал, д.32, кв.86', '+7(965)640-03-02', '2005-02-21', 'doctor'),
(3, 'Тетерев Олег Витальевич', '1995-05-01', 'Москва, ул.Взлетная, д.50, кв.69', '+7(965)112-55-43', '2018-04-23', 'without degree'),
(4, 'Добролюбов Пётр Андреевич', '1972-03-02', 'Москва, ул.Дальняя, д.85, кв.44', '+7(965)765-83-44', '2006-03-18', 'master'),
(5, 'Царёва Анна Сергеевна', '1982-04-14', 'Москва, ул.Трехгорный Вал, д.5, кв.73', '+7(965)333-56-32', '2010-04-17', 'master'),
(6, 'Петров Александр Васильевич', '1999-11-13', 'Москва, ул.Рабочая, д.96, кв.83', '+7(965)125-65-35', '2019-11-14', 'bachelor'),
(7, 'Петренко Тамара Ивановна', '1977-07-14', 'Москва, ул.Трехгорный Вал, д.54', '+7(965)563-34-64', '2005-02-03', 'doctor'),
(8, 'Дягтерёв Василий Алекссевич', '1984-11-24', 'Москва, ул.Бакинская, д.55, кв.33', '+7(965)124-65-32', '2017-04-18', 'master'),
(9, 'Гончаров Сергей Рудольфович', '1979-12-14', 'Москва, ул.Салтыковская, д.91, кв.86', '+7(965)563-23-67', '2007-03-02', 'doctor'),
(10, 'Тычкин Сергей Игоревич', '1988-11-21', 'Москва, ул.Вересковая, д.11, кв.85', '+7(965)272-14-54', '2014-07-18', 'without degree');
